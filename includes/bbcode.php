	...
	function bbcode_tpl($tpl_name, $bbcode_id = -1, $skip_bitfield_check = false)
	{
		...
		if (empty($bbcode_hardtpl))
		{
			...
			$bbcode_hardtpl = array(
				...
				'u_close'	=> '</span>',
				'img'		=> (!$ppkbb_spoiler_options[4] && $ppkbb_spoiler_options[5] ? '<a href="$1" rel="prettyPhotoSpoiler[0]">' : '').'<var title="$1" class="postImg">'.$img_wojs.'</var>'.(!$ppkbb_spoiler_options[4] && $ppkbb_spoiler_options[5] ? '</a>' : ''),
