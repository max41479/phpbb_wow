...
* @package functions_recruit_version_check.php
* @version $Id: v2.1.0
...
*/
function recruit_version_check($return_version = false)
{
	...
	if (!class_exists('recruit_version_check'))
	{
		include($phpbb_admin_path . 'mods/recruit_version_check.' . $phpEx);
	}
	$class_name = 'recruit_version_check';
	...
	if ($file)
	{
		if (version_compare(PHP_VERSION, '5.0.0', '<'))
		{
			...
			$mod_version = $row['recruit_version'];
