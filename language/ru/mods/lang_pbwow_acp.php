...
$lang = array_merge($lang, array(
	'ANNOUNCEMENT_TOPIC'	=> 'Объявление о релизе',
	'CURRENT_VERSION'		=> 'Текущая версия',
	'DOWNLOAD_LATEST'		=> 'Скачать последнюю версию',
	'LATEST_VERSION'		=> 'Последняя версия',
	'NO_INFO'				=> 'Невозможно подключиться к серверу проверки версии',
	'NOT_UP_TO_DATE'		=> '%s не самой последней версии',
	'RELEASE_ANNOUNCEMENT'	=> 'Тема с объявлением',
	'UP_TO_DATE'			=> '%s самой последней версии',
	'VERSION_CHECK'			=> 'Проверка версии MODа',

	'ACP_PBWOW_INDEX_TITLE'				=> 'Главная модуля PBWoW',
	'ACP_PBWOW_INDEX_TITLE_EXPLAIN'		=> 'Благодарим Вас за выбор PBWoW, надеемся, вам понравится.',
	

	// OVERVIEW //
	'ACP_PBWOW2_OVERVIEW_TITLE'			=> 'Обзор модуля PBWoW 2',
	'ACP_PBWOW2_OVERVIEW_TITLE_EXPLAIN'	=> 'Благодарим Вас за выбор PBWoW, надеемся, вам понравится.',
	'ACP_PBWOW_INDEX_SETTINGS'			=> 'Общая информация',

	'ACP_PBWOW_DB_CHECK'				=> 'Проверка базы данных PBWoW',
	'PBWOW_DB_GOOD'						=> 'Найдена таблица конфигурации PBWoW (%s)',
	'PBWOW_DB_BAD'						=> 'Не найдена таблица конфигурации PBWoW. Проверьте что таблица (%s) существует в вашей базе данных phpBB.',
	'PBWOW_DB_BAD_EXPLAIN'				=> 'Запустите скрипт установки PBWoW 2, включенный в пакет MODа. Он создаст и заполнит соответствующую таблицу базы данных.',
	'PBWOW_DB_CREATE'					=> 'Создать таблицу конфигурации PBWoW',
	'PBWOW_DB_CREATE_EXPLAIN'			=> 'Вы не создали таблицу конфигурации для вашей установки PBWoW. Либо сделайте это вручную, либо нажмите кнопку &quot;Установить&quot;.',
	'PBWOW_CONSTANTS_BAD'				=> 'Константы не установлены! Это означает, что PBWoW 2 MOD не был установлен корректно!',
	'PBWOW_CONSTANTS_BAD_EXPLAIN'		=> 'Попробуйте установить MOD снова, или вручную добавить следующую строку в ваш файл includes/constants.php:<br /><br />define(\'PBWOW2_CONFIG_TABLE\', $table_prefix . \'pbwow2_config\');',

	'ACP_PBWOW_VERSION_CHECK'			=> 'Проверка версии PBWoW',
	'PBWOW_DATABASE_VERSION'			=> 'Версия базы данных',
	'PBWOW_ACP_MODULE_VERSION'			=> 'Версия модуля ACP',
	'PBWOW_ACP_TEMPLATE_VERSION'		=> 'Версия шаблона ACP',
	'PBWOW_STYLE_VERSION'				=> 'Версия стиля',
	'PBWOW_IMAGESET_VERSION'			=> 'Версия набора рисунков',
	'PBWOW_TEMPLATE_VERSION'			=> 'Версия шаблона',
	'PBWOW_THEME_VERSION'				=> 'Версия темы',
	'PBWOW_VERSION_ERROR'				=> 'Невозможно определить версию!',
	'PBWOW_CHECK_UPDATE'				=> 'Проверьте <a href="http://pbwow.com/forum/index.php">PBWoW.com</a> на наличие доступных обновлений.',

	'ACP_PBWOW_CPF_CHECK'				=> 'Проверка дополнительных полей профиля',
	'PBWOW_ACTIVE'						=> 'Активно',
	'PBWOW_INACTIVE'					=> 'Неактивно',
	'PBWOW_DETECTED'					=> 'Обнаружено',
	'PBWOW_NOT_DETECTED'				=> 'Не обнаружено',
	'PBWOW_OBSOLETE'					=> 'больше не используется',
	'PBWOW_CPF_MEMBERLIST'				=> 'Разрешить отображение дополнительных полей профиля в списке пользователей',
	'PBWOW_CPF_VIEWPROFILE'				=> 'Показывать дополнительные поля в профилях пользователей',
	'PBWOW_CPF_VIEWTOPIC'				=> 'Показывать дополнительные поля на страницах тем',
	'PBWOW_CPF_CREATE_LOCATION'			=> 'Создайте или включите это поле через ACP > Пользователи и группы > Дополнительные поля в профиле',
	'PBWOW_CPF_LOAD_LOCATION'			=> 'Включите это через ACP > Общие > Конфигурация > Функции конференции',

	'ACP_PBWOW_DONATE'					=> 'Поддержать PBWoW',
